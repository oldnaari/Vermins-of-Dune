...
namespace OpenRA.Mods.D2KSmugglers.Projectiles
{
	...
	public class SalvageBomb : IProjectile, ISync
	{
		...
		public SalvageBomb(SalvageBombInfo info, ProjectileArgs args)
		{
			...
			{
				var color = info.ContrailUsePlayerColor
					? SalvageContrailRenderable.ChooseColor(args.SourceActor)
					: info.ContrailColor;
				contrail = new SalvageContrailRenderable(world, color, info.ContrailWidth, info.ContrailLength,
					info.ContrailDelay, info.ContrailZOffset);
			}
		}
